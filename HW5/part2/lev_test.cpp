...
static void moveVehicleErrorsTest() {
	...
	MoveVehicle<gameBoard, 2, 3, RIGHT, 1>m30; (void)m30; // X
	MoveVehicle<gameBoard, 4, 3, LEFT,  1>m31; (void)m31; // P
	MoveVehicle<gameBoard, 5, 2, UP,    4>m32; (void)m32; // B
	MoveVehicle<gameBoard, 1, 4, DOWN,  2>m33; (void)m33; // O
}
